...
public class LauncherViewPropertyAnimator extends Animator implements AnimatorListener {
    ...
    public void start() {
        ...
        //TODO:ICS_FIX (below may be pointless.  Will mPropertiesToSet have Properties.WITH_LAYER below JB?)
     /*   if ((mPropertiesToSet.contains(Properties.WITH_LAYER)) && (Build.VERSION.SDK_INT >=16)) {
