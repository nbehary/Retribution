...
package com.nbehary.retribution.util;
...
class IabHelper {
    ...
    private void launchPurchaseFlow(Activity act, String sku, int requestCode,
    ...
    private Inventory queryInventory(boolean querySkuDetails, List<String> moreSkus) throws IabException {
