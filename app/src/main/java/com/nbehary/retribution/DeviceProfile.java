...
class DeviceProfile {
    ...
    float minHeightDps;
    float numRows;
    private float numRowsCalc;
    float numRowsDevice;
    float numColumns;
    private float numColumnsCalc;
    ...
    private int searchBarSpaceWidthPxDefault;
    private int searchBarSpaceMaxWidthPxDefault;
    int searchBarSpaceHeightPxDefault;
    private int searchBarHeightPxDefault;
